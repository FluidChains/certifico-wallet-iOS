...
class RenderedCertificateView: UIView {
    ...
    func render(certificate: Certificate) {
        if let html = certificate.htmlDisplay {
            ...
            let customCss = "body {padding: 20px; font-size: 12px; line-height: 1.5;} body > section { padding: 0;} body section { max-width: 100vw; overflow-wrap: break-word; } body table { width: auto !important } body img { max-width: 100%; object-fit: contain; height: auto; } .bgImage { background-image: none !important; height: auto; }"
